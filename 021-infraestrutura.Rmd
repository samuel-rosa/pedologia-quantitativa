...
Conforme vimos no capítulo anterior, a aplicação de métodos quantitativos (matemáticos e estatísticos) para o
...
Os *softwares* disponíveis para o desenvolvimento de estudos quantitativos são inúmeros e diversos, gratuitos
ou privados, sendo geralmente necessário usar dois ou mais *softwares* para desenvolver qualquer estudo -- por
mais simples que o estudo seja. Para aprender e dominar o uso desses *softwares*, possivelmente alguns dos
quais lhe são desconhecidos até então, a pedologia quantitativa exigirá que você aprenda a "linguagem" desses
*softwares*. Como sabemos, uma linguagem é um sistema de signos (símbolos ou palavras) convencionados que 
serve para a comunicação de conceitos, ideias, significados, pensamentos -- veja mais sobre linguagem na
[Wikipedia]("https://pt.wikipedia.org/wiki/Linguagem"). Assim, a linguagem de um *software* será, também um
sistema de signos convencionados, mas que serve para a nossa comunicação com um computador. Essa "linguagem" 
